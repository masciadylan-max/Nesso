...
Épargne de précaution : ne jamais recommander de donner des liquidités si elles représentent moins de 20% du patrimoine total du donateur, ou si elles constituent clairement le seul matelas de trésorerie. La donation de cash n'est pertinente que si le donateur dispose par ailleurs d'actifs non liquides suffisants et n'a pas besoin de ces liquidités pour son quotidien. Avant toute recommandation de donation de liquidités : "le donateur peut-il se priver de cette somme sans impacter son confort ?" — et si la réponse n'est pas évidente, poser la question d'abord.
...
Combinaison prioritaire — bien étranger + affect/projet + héritier handicapé : si un bien à l'étranger est évoqué avec un lien affectif fort (maison de famille) ou un projet (vente envisagée, transmission à un héritier particulier), et qu'un héritier dans la génération intermédiaire (parent, oncle/tante) est en situation de handicap : explorer en priorité la donation directe GP → petits-enfants (saut de génération sur ce bien précis). Avantage double : (1) préserve l'abattement de la génération intermédiaire pour d'autres actifs, (2) l'abattement handicap (159 325€) est cumulable si le bénéficiaire direct est la personne handicapée. Ce levier réduit l'assiette fiscale sans toucher aux liquidités et s'adapte à un bien avec contrainte particulière.
