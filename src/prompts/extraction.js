...
Compagne/concubin = toujours renseigner le champ 'conjoint' avec son prénom si mentionné(e) dans la conversation ou dans le formulaire de cadrage. RÈGLE ABSOLUE : si une personne de vie commune (conjoint, partenaire, compagne, compagnon) est mentionnée à n'importe quel endroit de la conversation ou du formulaire, le champ 'conjoint' NE PEUT PAS être null. Ses actifs propres restent hors 'actifs' de l'utilisateur — sauf bien explicitement co-détenu.
